/**
 * This file contains a list of event messages that are used to map the Windows event log event ID to a human-readable
 * message.
 *
 * The data has been reproduced from Microsoft's official documentation, available at:
 * - https://www.microsoft.com/en-us/download/details.aspx?id=50034
 * - https://learn.microsoft.com/en-us/windows-server/identity/ad-ds/plan/appendix-l--events-to-monitor
 *
 * The Windows server documentation is licensed under the Creative Commons CC BY 4.0 DEED Attribution 4.0 International
 * license, available at: https://raw.githubusercontent.com/MicrosoftDocs/windowsserverdocs/main/LICENSE
 *
 * The data has been converted from an XLXS spreadsheet file to a JSON file using the Python script available at
 * /tools/events_to_json.py
 */
